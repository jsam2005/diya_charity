...
const translations: Record<Language, Record<string, string>> = {
  ...
  hi: {
    ...
    upiIdForAutoDebit: 'ऑटो-डेबिट के लिए UPI ID',
    upiAutoDebitNote: 'स्वचालित मासिक दान सक्षम करने के लिए अपना UPI ID दर्ज करें (जैसे, yourname@paytm, yourname@ybl)। JioStar सब्सक्रिप्शन की तरह, आपका भुगतान हर महीने स्वचालित रूप से डेबिट होगा।',
    ...
    buddingMindsDesc: 'स्कूल ड्रॉपआउट अंतराल को पाटना, कौशल प्रशिक्षण, और वंचित युवाओं के लिए मनोवैज्ञानिक परामर्श।',
